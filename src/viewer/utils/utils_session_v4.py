...
session_state
├── cloud        # auth, identity, cloud flags
├── system       # app-wide config, constants, debug flags
├── paths        # filesystem paths
├── user         # user selections (project, pipeline, subject…)
├── data         # loaded dataframes, dicts, ref data
├── ui           # UI-only state (debug selections, toggles)
├── dicoms       # dicom-related transient state
'''
